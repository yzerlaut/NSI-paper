...
# python exp_data.py -tda -f data/final_alpha_first_half.npz --parallelize --discretization 40 --subsampling_period 1e-3 --alpha_min 1. --alpha_max 7. --data_fraction 0. 0.5 &
python exp_data.py -tda -f data/final_alpha_last_half.npz --parallelize --discretization 40 --subsampling_period 1e-3 --alpha_min 1. --alpha_max 7. --data_fraction 0.5 1. &
